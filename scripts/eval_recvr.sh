...
#SBATCH --output=./results_extra/eval-recvr-%j-%N.out
#SBATCH --job-name=eval-recvr
...
LOG_DIR_RECVR="recovery_deepseek_7b_log"
METHOD="grad_diff"
RECOVER_TYPE="flip"
FLIP="1"
BEAM_K="1"
...
echo "Evaluate recovery: type=${RECOVER_TYPE}, set=${UNLEARN_SET}, method=${METHOD}"
