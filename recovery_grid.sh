...
python recovery.py  --unlearnSet "unlearn-N1" --datasetType "forget"  --modelType 'unlearned'  --flip_logit 0 \
      --unlearn_method  $METHOD --num_fgt 2025  --lr_fgt $LR  --LoRA_rank_fgt $R --eps_fgt $EPOCHS --reg_weights_fgt 1.0
python recovery.py  --unlearnSet "unlearn-N1" --datasetType "forget"  --modelType 'unlearned'  --flip_logit 1 \
      --unlearn_method  $METHOD --num_fgt 2025  --lr_fgt $LR  --LoRA_rank_fgt $R --eps_fgt $EPOCHS --reg_weights_fgt 1.0