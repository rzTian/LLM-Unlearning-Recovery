...
def parser_eval():
    parser = argparse.ArgumentParser()
    parser.add_argument('--datasetName', default='FPI', type=str)
    parser.add_argument('--datasetType', default="forget-N1-A1", type=str)
    ...
    parser.add_argument('--num_fgt_prof', default=1, type=int)
    parser.add_argument('--num_fgt_attr', default=1, type=int)
...
def parser_unlearn():
    ...
    parser.add_argument('--num_fgt_prof', default=1, type=int)
    parser.add_argument('--num_fgt_attr', default=1, type=int)
    parser.add_argument('--forgetSetDir', default="forget-N_1-attr-1.json" , type=str)
    parser.add_argument('--retainSetDir', default="retain-N_1-attr-1.json" , type=str)
