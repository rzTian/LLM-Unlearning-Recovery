...
#SBATCH --output=./results_extra/eval-%N-%j-%a.out  # %N for node name, %j for jobID, %a for array ID
...
python evaluate.py  --datasetType "forget-1"  --modelType 'base'
python evaluate.py  --datasetType "retain-1"  --modelType 'base'
